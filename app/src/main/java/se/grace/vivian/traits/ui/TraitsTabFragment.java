...
public class TraitsTabFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /**
         * TextView personalityScore = (TextView) mViewPager.findViewById(R.id.traitsTabScoreValue); //traitsTabScoreValue
         personalityScore.setText(mPersonality.getPercentage() + " %");
         */
